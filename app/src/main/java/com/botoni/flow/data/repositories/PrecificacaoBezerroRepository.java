...
public class PrecificacaoBezerroRepository {
    ...
    private final PrecificacaoPorFaixa precificacaoPorFaixa = new PrecificacaoPorFaixa();
    ...
    public PrecificacaoBezerro calcularNegociacaoBezerro(BigDecimal peso, BigDecimal precoPorArroba, BigDecimal percentualAgio, Integer quantidade) {
        BigDecimal valorPorCabeca = precificacaoPorFaixa.calcularValorTotalBezerro(peso, precoPorArroba, percentualAgio);
        BigDecimal valorPorKg = precificacaoPorFaixa.calcularValorPorKg(peso, precoPorArroba, percentualAgio);
        BigDecimal valorTotal = precificacaoPorFaixa.calcularValorTotalLote(valorPorCabeca, quantidade);
        return new PrecificacaoBezerro(valorPorKg, valorPorCabeca, valorTotal);
    }

    public static class PrecificacaoPorPeso {

    }

    private static class PrecificacaoPorFaixa {
