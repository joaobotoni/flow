...
public class AvaliacaoPrecoAnimalUseCase {
    ...
    public static BigDecimal calcularValorTotalTodosBezerros(BigDecimal valor, Integer quantidade) {
    ...
    public static BigDecimal calcularValorTotalBezerro(BigDecimal pesoKg, BigDecimal precoPorArroba, BigDecimal inputPercentualAgio) {
        if (pesoKg == null) {
        ...
        return calcularValorBasePorPeso(pesoKg, precoPorArroba)
                .add(calcularValorTotalAgio(pesoKg, precoPorArroba, inputPercentualAgio))
                .setScale(ESCALA_RESULTADO, MODO_ARREDONDAMENTO);
    }

    public static BigDecimal calcularValorTotalPorKg(BigDecimal pesoKg, BigDecimal precoPorArroba, BigDecimal inputPercentualAgio) {
        if (pesoKg == null) {
            throw new IllegalArgumentException("O peso em kg não pode ser nulo");
        }
        if (precoPorArroba == null) {
        ...
        return calcularValorTotalBezerro(pesoKg, precoPorArroba, inputPercentualAgio)
    ...
    private static BigDecimal calcularValorTotalAgio(BigDecimal pesoKg, BigDecimal precoPorArroba, BigDecimal inputPercentualAgio) {
        ...
        return estaNoOuAcimaPesoBase(pesoKg)
                ? calcularAgioAcimaPesoBase(pesoKg, precoPorArroba, inputPercentualAgio)
                : calcularAgioAbaixoPesoBase(pesoKg, precoPorArroba, inputPercentualAgio);
    }
    ...
    private static BigDecimal calcularAgioAcimaPesoBase(BigDecimal pesoKg, BigDecimal precoPorArroba, BigDecimal inputPercentualAgio) {
        ...
        return obterArrobasRestantesParaAbate(pesoKg)
                .multiply(calcularAgioPorArrobaNoPesoBase(pesoKg, precoPorArroba, inputPercentualAgio));
    }
    ...
    private static BigDecimal calcularAgioPorArrobaNoPesoBase(BigDecimal pesoKg, BigDecimal precoPorArroba, BigDecimal inputPercentualAgio) {
        ...
        return obterValorReferenciaAgioNoPesoBase(precoPorArroba, inputPercentualAgio)
    ...
    private static BigDecimal obterValorReferenciaAgioNoPesoBase(BigDecimal precoPorArroba, BigDecimal inputPercentualAgio) {
        ...
        return calcularTaxaPorArrobaRestante(PESO_BASE_KG, precoPorArroba)
                .add(calcularAgioPorArrobaExatamenteNoPesoBase(precoPorArroba, inputPercentualAgio));
    }
    ...
    private static BigDecimal calcularAgioPorArrobaExatamenteNoPesoBase(BigDecimal precoPorArroba, BigDecimal inputPercentualAgio) {
        ...
        return calcularValorAgioNoPesoBase(precoPorArroba, inputPercentualAgio)
    ...
    private static BigDecimal calcularValorAgioNoPesoBase(BigDecimal precoPorArroba, BigDecimal inputPercentualAgio) {
        ...
        return calcularValorPesoBaseComAgio(precoPorArroba, inputPercentualAgio)
    ...
    private static BigDecimal calcularValorPesoBaseComAgio(BigDecimal precoPorArroba, BigDecimal inputPercentualAgio) {
        ...
        return converterKgParaArrobas(PESO_BASE_KG).multiply(precoPorArroba)
                .divide(obterFatorMultiplicadorAgio(inputPercentualAgio), ESCALA_CALCULO, MODO_ARREDONDAMENTO);
    }
